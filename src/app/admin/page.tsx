...
export default function AdminOverviewPage() {
  ...
  return (
    <div className="space-y-8">
      <div>
        <h1 className="font-manrope font-bold text-2xl text-text">Admin Dashboard</h1>
      ...
      {Object.keys(stats.auditsByStatus).length > 0 && (
        <div className="bg-card border border-border rounded-xl p-5">
          <h2 className="font-manrope font-semibold text-sm text-text mb-4">Audits by Status</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-manrope font-semibold text-sm text-text">Recent Users</h2>
        ...
        <div className="bg-card border border-border rounded-xl p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="font-manrope font-semibold text-sm text-text">Recent Audits</h2>
