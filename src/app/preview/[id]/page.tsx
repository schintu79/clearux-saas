      ...
      <main className="min-h-screen bg-off">
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-xl text-center">
              ...
              <div className="mt-6 space-y-3">
                <Link
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-lg px-6 py-3 font-body text-sm font-semibold bg-brand text-surface dark:text-[#1C1C1C] transition-all hover:shadow-lg active:scale-95"
                >
          ...
          <div className="rounded-lg border border-border bg-card p-8 text-center sm:p-12">
            ...
            <Link
              href={`/register?redirect=/dashboard/audits/${auditId}&claim=${auditId}`}
              className="mt-6 inline-flex items-center gap-2 rounded-lg px-6 py-3 font-body text-sm font-semibold bg-brand text-surface dark:text-[#1C1C1C] transition-all hover:shadow-lg active:scale-95"
            >
              Get Full Audit
              <ArrowRight className="h-4 w-4" />
            </Link>
