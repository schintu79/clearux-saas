...
const SettingsPage: React.FC = () => {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      {/* Header */}
      <div className="mb-6">
        <h1 className="text-2xl font-bold font-body text-text">Settings</h1>
      ...
      {activeTab === 'profile' && (
        <Card>
          <div className="space-y-6">
            <div>
              <h2 className="text-lg font-bold font-body text-text">Profile Information</h2>
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <h2 className="text-lg font-bold font-body text-text">Company & Billing</h2>
              </div>
      ...
      {activeTab === 'security' && (
        <div className="space-y-6">
          <Card>
            <div className="space-y-6">
              <div>
                <h2 className="text-lg font-bold font-body text-text">Change Password</h2>
