...
export default function BeyondTheReport() {
  ...
  return (
    <section className="relative py-32 sm:py-40 px-4 md:px-6 lg:px-8 bg-surface overflow-hidden">
      {/* Subtle floating orbs — dark mode only */}
      <motion.div
        className="absolute top-[8%] left-[-4%] w-[350px] h-[350px] rounded-full pointer-events-none hidden dark:block"
      ...
      />
      <motion.div
        className="absolute bottom-[12%] right-[-4%] w-[300px] h-[300px] rounded-full pointer-events-none hidden dark:block"
