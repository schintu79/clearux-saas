          ...
          {DIFFERENTIATORS.map((diff, idx) => {
            ...
            return (
              ...
              >
                ...
                >
                  <motion.span
                    className="font-heading text-7xl sm:text-8xl font-bold text-[#111]/[0.06] mb-3 leading-none"
                    initial={{ opacity: 0, scale: 0.5 }}
                  ...
                  <p className="text-xs font-semibold uppercase tracking-wider text-[#111]/40 mb-2">{diff.subtitle}</p>
