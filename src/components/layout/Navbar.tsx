      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        <div className="flex justify-between items-center h-16">
          ...
          <Link href="/" className="flex-shrink-0 flex items-center gap-1" aria-label="ClearUX home">
            <span className="font-heading text-2xl font-semibold tracking-[0.2px] text-white">clear<span className="text-lime-gradient">ux</span><span className="opacity-50">.ai</span></span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-2">
            {isLoggedIn ? (
              ...
              <>
                ...
                <Link
                  href="/register"
                  className="text-[15px] font-semibold text-[#111114] bg-lime-gradient hover:opacity-90 rounded-full px-5 py-2.5 min-h-[44px] transition-all hover:-translate-y-0.5 flex items-center gap-1.5"
                >
                  Start Free Audit
              ...
              <div className="flex flex-col gap-1 pt-3 border-t border-white/[0.06] mt-2">
                {isLoggedIn ? (
                  ...
                  <>
                    ...
                    <Link href="/register" onClick={() => setIsOpen(false)} className="text-[15px] font-semibold text-[#111114] bg-lime-gradient rounded-full px-6 py-3 text-center min-h-[48px] flex items-center justify-center mt-1">
                      Start Free Audit
                    </Link>
                  </>
                )}
