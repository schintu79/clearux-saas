      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 mb-12">
          ...
          <div className="md:max-w-[260px] flex-shrink-0">
            ...
            <div className="flex items-center gap-3">
              <a
                href="https://www.instagram.com/fixpath.ai"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow Fixpath on Instagram"
              ...
              <a
                href="https://www.linkedin.com/company/fixpath"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="Follow Fixpath on LinkedIn"
                className="w-9 h-9 rounded-lg flex items-center justify-center text-white/40 hover:text-white bg-white/[0.06] hover:bg-white/[0.10] transition-all"
              >
          ...
          <div className="flex-1 grid grid-cols-2 sm:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2.5">
                ...
                <li>
                  <a href="mailto:support@fixpath.ai" className="font-body text-sm text-white/70 hover:text-white transition-colors">
                    support@fixpath.ai
                  </a>
                </li>
              </ul>
        ...
        <div className="pt-8 border-t border-white/[0.08] flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="font-body text-xs text-white/70">
            &copy; {currentYear} Fixpath. All rights reserved.
          </p>
