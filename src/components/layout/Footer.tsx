      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16">
        ...
        <div className="flex flex-col md:flex-row gap-12 md:gap-16 mb-12">
          ...
          <div className="md:max-w-[260px] flex-shrink-0">
            <div className="mb-3"><span className="font-heading text-2xl font-bold tracking-[0.6px] text-white">clear<span className="text-lime-gradient">ux</span><span className="opacity-50">.ai</span></span></div>
