...
const FAQ_ITEMS = [
  ...
  { q: 'What does the audit cover?', a: 'We evaluate 19 critical UX categories: First Impression & Visual Design, AI Discoverability, Value Proposition, Navigation, Conversion & CTAs, Onboarding, Mobile Experience, Trust & Credibility, Content Quality, Performance, Visual Hierarchy, Accessibility, and Cognitive Accessibility & Neurodiversity.' },
