...
const HOME_FAQS = [
  ...
  { q: 'How does ClearUX compare to hiring a UX consultant?', a: "A traditional UX audit costs $5,000–15,000 and takes 2–4 weeks. ClearUX delivers 96 checkpoints across six modules in minutes for a fraction of the cost. It's ideal for quick, comprehensive baseline assessments." },
  { q: 'Does ClearUX replace a human UX auditor?', a: "No. ClearUX is designed to complement human expertise, not replace it. It covers 96 checkpoints across six modules in minutes — the kind of breadth that would take a consultant days. But for deep qualitative research, we recommend working with a specialist." },
