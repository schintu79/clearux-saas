...
export function Comparison() {
  return (
    <>
      ...
      <section
        className="py-[100px] max-sm:py-[72px]"
        style={{ background: 'var(--ink)', color: 'var(--paper)' }}
      >
        <div className="max-w-mkt mx-auto px-8 max-sm:px-5 text-center">
          <p
            className="font-serif font-normal leading-[1.12] tracking-[-0.022em] mx-auto"
            style={{ fontSize: 'clamp(28px, 4.2vw, 56px)', maxWidth: '820px' }}
          >
            Other tools measure how happy{' '}
            <em className="italic" style={{ color: 'var(--m-muted)' }}>Google</em>{' '}
            is with your site.
            <br className="max-sm:hidden" />{' '}
            <span style={{ color: 'var(--signal)' }}>ClearUX audits the human experience.</span>
          </p>
        </div>
      </section>
            ...
            {cards.map((card) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Competitor side */}
                  <div className="px-6 py-5" style={{ borderBottom: '1px solid var(--rule)' }}>
                    ...
                    <p className="text-[14px] font-sans font-medium text-ink leading-[1.35] mb-1.5">
                    ...
                    <p
                      className="text-[11px] font-mono tracking-[0.02em] text-m-muted/70 italic"
                    >
                  ...
                  <div
                    ...
                    style={{ background: 'color-mix(in srgb, var(--signal) 3%, transparent)' }}
                  >
                    <div className="flex items-center gap-2 mb-3">
                      <span
                        className="font-mono text-[10px] tracking-[0.08em] uppercase font-medium px-2 py-0.5 rounded"
                    ...
                    <p className="text-[12px] font-sans text-ink-2 leading-[1.5] mb-3">
                      {card.clearux.detail}
                    </p>
                    <p
