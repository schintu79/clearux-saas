    ...
    try {
      const resp = await Promise.race([
        client.messages.create({
          model: modelUsed,
          max_tokens: 500,
          system: 'You are a knowledgeable assistant. Answer the question based on what you know. If you are not sure or have limited information, say so clearly. Do not make things up.',
...
- "accuracy": one of "accurate" (factually correct and matches ground truth), "partial" (some correct info but incomplete or slightly off), "inaccurate" (wrong information that contradicts ground truth), "hallucinated" (made up specific details not found anywhere on the site), "no_data" (AI correctly said it doesn't know or has limited info)
