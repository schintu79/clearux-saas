...
const UI_LABELS: Record<string, UILabels> = {
  ...
  es: {
    ...
    descAnalysing: 'Ejecutando analisis profundo en 28 categorias...',
    ...
    qualitativeNote: 'Para investigacion cualitativa profunda (entrevistas, pruebas de usabilidad), recomendamos complementar los hallazgos de Fixpath con un especialista.',
  ...
  fr: {
    ...
    descAnalysing: 'Analyse approfondie sur 28 categories en cours...',
    ...
    qualitativeNote: 'Pour une recherche qualitative approfondie (entretiens, tests d\'utilisabilite), nous recommandons de combiner les resultats Fixpath avec un specialiste.',
  ...
  de: {
    ...
    descAnalysing: 'Tiefenanalyse uber 28 Kategorien lauft...',
    ...
    qualitativeNote: 'Fur tiefgehende qualitative Forschung (Nutzerinterviews, Usability-Tests) empfehlen wir, Fixpath-Ergebnisse mit einem Spezialisten zu kombinieren.',
  ...
  it: {
    ...
    qualitativeNote: 'Per ricerche qualitative approfondite (interviste, test di usabilita), consigliamo di combinare i risultati Fixpath con uno specialista.',
  ...
  pt: {
    ...
    descAnalysing: 'Executando analise profunda em 28 categorias...',
