...
`
  ...
  <div class="page">
    ...
    <div class="method-note">
      This report was generated by ${esc(brandName)}'s AI-powered audit engine. Each of the 28 categories is scored against specific checkpoints derived from WCAG 2.1, Nielsen Norman heuristics, and modern SEO best practices.
    </div>
  </div>
`
