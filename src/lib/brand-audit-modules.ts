...
export const BRAND_AUDIT_CATEGORIES: BrandAuditCategory[] = [
  ...
  {
    slug: 'competitive_positioning',
    name: 'Competitive Positioning',
    description:
      'How effectively the brand positions itself in the market, communicates its market category, and differentiates from alternatives.',
    analysisPrompt:
      'Evaluate the brand\'s competitive positioning as communicated through these materials. Assess: clarity of market category and positioning, how the brand differentiates from alternatives, whether competitive advantages are clearly communicated, the strength of the brand narrative and story, market awareness signals, and whether positioning is consistent across all materials.',
    weight: 0.14,
    sortOrder: 5,
  },
  {
